...
//Copies the HAL_CAN_GetRxMessage into your own data structure [motor_chassis]
...
/**
  * @brief          hal CAN fifo call back, receives and stores motor data
  * @param[in]      hcan, the point to CAN handle
  * @retval         none
  *
 [DANTE]
  * Takes the can identifier and stores data in motor_chassis
  * User defined but declared in Driver
  * Does not need to be called, will be called routinely whenever it gets message
  *
  */
...
{
    uint32_t send_mail_box;
    chassis_tx_message.StdId = CAN_CHASSIS_ALL_ID2;
    chassis_tx_message.IDE = CAN_ID_STD;
    chassis_tx_message.RTR = CAN_RTR_DATA;
    chassis_tx_message.DLC = 0x08;
