...
#define M_TURRET_PITCH_LOWER_LIMIT 0.1
#define M_TURRET_PITCH_UPPER_LIMIT 1.0
...
#define CONF_SHOOTER_SPEED_PERCENTAGE_1 0.80f                               // Level 1
...
#define M_GM6020_VOLTAGE_MAX 0.5f
// Snail
